...
if __name__ == '__main__':
    ...
    times= 1000
    resultDir = '/data/home/xuejin/code/SH_OzoneTrend/results/remove_weather_noseason_shap_0916'
    if not os.path.exists(resultDir): # 如果文件夹不存在则创建
        os.makedirs(resultDir)
        
    '''空气质量数据前处理'''
    aqData_path = r'/data/home/xuejin/code/SH_OzoneTrend/airQuality/SHdata_3sites_2013_2021_除超过6小时缺值天线性插值.csv'
    ...
    '''气象数据前处理'''
    era_path = r'/data/home/xuejin/code/SH_OzoneTrend/metData/SH_ERA5_1997_2021.csv'
    ...
    # shap_interaction_values = model_shap_interaction_values_mtp(x_explain,nrows,RFmodel_wc,number_of_processors=number_of_processors)
    # with open(r'%s/shap_interaction_values_%s_%s.pkl'%(resultDir,pol,sitename), 'w+b') as fp: 
    #     pickle.dump(shap_interaction_values, fp)